    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 全部商品列表
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="numbe" label="库存 /件"></el-table-column>
                <el-table-column label="状态" align="center">
                    <template slot-scope="scope">
                        <el-tag
                        >{{scope.row.states==1 ? '上架' : '下架'}}</el-tag>
                    </template>
                </el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="70px">
                ...
                <el-form-item label="库存">
                    <el-input v-model="form.numbe"></el-input>
                </el-form-item>
                <el-form-item label="状态">
                    <el-input v-model="form.states"></el-input>
                </el-form-item>
            </el-form>
...
<script>
import { fetchData,editdata,deleteedit,searchedit } from '../../api/index';
import qs from 'qs'
export default {
    name: 'basetable',
    data() {
